...
namespace WebApi.Controllers
{
    ...
    {
        [HttpGet]
        [Route("api/Profile/ProfileDetails")]
        ...
        [HttpPost]
        [Route("api/Profile/ProfilePictureUpload")]
        ...
        [HttpGet]
        [Route("api/Profile/ProfilePictureView")]

        //Get Profile Picture for view
        public HttpResponseMessage ProfilePictureView()
        {
            // Fetch User ID from Basic Authentication
            string ID = Thread.CurrentPrincipal.Identity.Name;
        ...
        [HttpGet]
        [Route("api/Profile/DownloadPicture")]

        //Download Picture Method
        public HttpResponseMessage DownlaodPicture()
        {
